...
1. In the left pane, choose your managed domain, such as *aadds.contoso.com*.
...
1. In the **Locations** dialog, expand the domain name, such as *aadds.contoso.com*, then select an OU, such as **AADDC Users**. If you have a custom OU that contains a group of users you wish to apply, select that OU.
