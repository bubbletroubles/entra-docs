...
1. First, use the `adcli info` command to verify you can see information about the managed domain. The following example gets information for the domain *aadds.contoso.com*. Specify your own managed domain name in ALL UPPERCASE:
